...
import 'package:stagenew/etatgeneral/q4.dart';

class Gsq3 extends StatefulWidget {

  @override
  State<Gsq3> createState() => _Gsq3();
}

class _Gsq3 extends State<Gsq3> {
  bool audio = false;
                ...
                SizedBox(
                  child: Column(
                    children: <Widget>[
                      ...
                      btn(size.width * .6, 'أكثر من 2 وجبات', Colors.greenAccent, r, 0),
                      btn(size.width * .6, 'أقل من 2 وجبات',
