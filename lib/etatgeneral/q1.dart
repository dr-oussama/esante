...
import 'package:stagenew/etatgeneral/q2.dart';

class Gsq1 extends StatefulWidget {

  @override
  State<Gsq1> createState() => _Gsq1();
}

class _Gsq1 extends State<Gsq1> {
  bool audio = false;
          ...
          child: SizedBox(
            ...
            child: Column(
              children: [
                ...
                Text(
                  "شحال ديال الخدمة كتقدر ديرها راسك ؟",
                ...
                SizedBox(
                  child: Column(
                    children: <Widget>[
                      btn(size.width * .6, 'كاملة', Colors.blueAccent, r, 3),
                      btn(size.width * .6, 'أكثر من نصف', Colors.greenAccent, r, 0),
                      btn(size.width * .6, 'أقل من نصف',
                          Colors.orangeAccent, r, 1),
                      btn(size.width * .6, 'لا', Colors.redAccent,
                          r, 2),
                    ],
                  ),
                ),
