...
class ConsQ1 extends StatefulWidget {
  const ConsQ1({Key? key}) : super(key: key);

  @override
  State<ConsQ1> createState() => _ConsQ1();
}

class _ConsQ1 extends State<ConsQ1> {
  bool audio = false;
          ...
          child: SizedBox(
            ...
            child: Column(
              children: [
                ...
                Text(
                  "شحال من  مرة تكرر عملية التخلص من البراز ؟",
                ...
                SizedBox(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      btn(size.width * .6, 'أقل من 4 مرات', Colors.greenAccent,
                          0),
                      btn(size.width * .6, '4-6 مرات', Colors.orangeAccent, 1),
                      btn(size.width * .6, 'أكثر من 7 مرات', Colors.redAccent,
                          2),
                    ],
                  ),
                ),
                ...
                SizedBox(
                  ...
                  child: FlatButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => ConsQ2(rep1)),
                      );
                    },
                    child: Text('الإضافة',
                        style: TextStyle(
