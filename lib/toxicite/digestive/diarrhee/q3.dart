...
class DiaQ3 extends StatefulWidget {
  String rep1 = '';
  String rep2 = '';
  DiaQ3(this.rep1, this.rep2);

  @override
  State<DiaQ3> createState() => _DiaQ3();
}

class _DiaQ3 extends State<DiaQ3> {
  bool audio = false;
  List<bool> r = [false, false, false, false, false, false];
  List<String> rep3 = [];
            ...
            child: Column(
              children: [
                ...
                SizedBox(
                  child: Column(
                    children: <Widget>[
                      btn(size.width * .6, 'لعيا', Colors.blueAccent, r, 0),
                      btn(size.width * .6, 'دم في البراز', Colors.greenAccent,
                          r, 1),
                      btn(size.width * .6, 'انسداد الأنبوب والارتباك العصبي',
                          Colors.orangeAccent, r, 2),
                      btn(size.width * .6, 'السخانة', Colors.redAccent, r, 3),
                      btn(size.width * .6, 'تبول أقل تواترا',
                          Colors.orangeAccent, r, 4),
                      btn(size.width * .6, 'البول أغمق من المعتاد',
                          Colors.redAccent, r, 5),
                    ],
                  ),
                ),
                SizedBox(
