...
import 'package:stagenew/toxicite/cutanee/mainpieds/q3.dart';
...
class MainQ2 extends StatefulWidget {
  String rep = '';
  MainQ2(this.rep, {Key? key}) : super(key: key);

  @override
  State<MainQ2> createState() => _MainQ2();
}

class _MainQ2 extends State<MainQ2> {
  bool audio = false;
  String rep2 = '';
                ...
                Footer(
                  ...
                  press: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => MainQ3(widget.rep, rep2)));
                  },
                ),
              ],
            ),
