...
class MainQ4 extends StatefulWidget {
  String rep = '';
  String rep2 = '';
  List<String> signes = [];

  MainQ4(this.rep, this.rep2, this.signes, {Key? key}) : super(key: key);

  @override
  State<MainQ4> createState() => _MainQ4();
}

class _MainQ4 extends State<MainQ4> {
  bool audio = false;
        ...
        child: SingleChildScrollView(
          child: SizedBox(
            ...
            child: Column(
              children: [
                Image.asset(
                  "lib/assets/mainpieds1.png",
                  height: size.height * 0.35,
                ),
                Text(
                  " واش أثر على الأنشطة اليومية ؟",
                  style: GoogleFonts.lato(
                    textStyle: const TextStyle(
                      decoration: TextDecoration.none,
                      color: Colors.black,
                ...
                SizedBox(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      btn(size.width * .6, 'غائبة', Colors.blueAccent, r, 0),
                      btn(size.width * .6, 'الأنشطة الآلية',
                          Colors.yellowAccent, r, 1),
                      btn(size.width * .6, 'الأنشطة الأولية', Colors.redAccent,
                          r, 2),
                    ],
                  ),
                ),
