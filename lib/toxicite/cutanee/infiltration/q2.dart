...
class InfiltrationQ2 extends StatefulWidget {
  String reponse = '';
  InfiltrationQ2(this.reponse, {Key? key}) : super(key: key);

  @override
  State<InfiltrationQ2> createState() => _InfiltrationQ2();
}

class _InfiltrationQ2 extends State<InfiltrationQ2> {
  bool audio = false;
  String rep = '';
