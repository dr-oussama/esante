...
class RashQ4 extends StatefulWidget {
  String rep1 = '';
  List<String> symptome = [];
  String rep3 = '';
  RashQ4(this.rep1, this.symptome, this.rep3, {Key? key}) : super(key: key);

  @override
  State<RashQ4> createState() => _RashQ4();
}

class _RashQ4 extends State<RashQ4> {
  bool audio = false;
