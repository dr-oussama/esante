...
import 'package:stagenew/toxicite/cutanee/rashcutanee.dart/q4.dart';
...
class RashQ3 extends StatefulWidget {
  String rep1 = '';
  List<String> symptome = [];
  RashQ3(this.rep1, this.symptome, {Key? key}) : super(key: key);

  @override
  State<RashQ3> createState() => _RashQ3();
}

class _RashQ3 extends State<RashQ3> {
  bool audio = false;
                ...
                Footer(
                  ...
                  press: () {
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                RashQ4(widget.rep1, widget.symptome, rep3)));
                  },
                ),
              ],
            ),
