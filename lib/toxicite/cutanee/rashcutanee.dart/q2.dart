...
import 'package:stagenew/toxicite/cutanee/rashcutanee.dart/q3.dart';
...
class RashQ2 extends StatefulWidget {
  String rep1 = '';

  RashQ2(this.rep1, {Key? key}) : super(key: key);

  @override
  State<RashQ2> createState() => _RashQ2();
}

class _RashQ2 extends State<RashQ2> {
  bool audio = false;
  List<bool> r = [false, false, false];
  List<String> symptome = [];
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      btn(size.width * .6, 'حكة', Colors.blueAccent, r, 0),
                      btn(size.width * .6, 'السخانة', Colors.yellowAccent, r,
                          1),
                      btn(size.width * .6, 'الآلام', Colors.redAccent, r, 2),
                    ],
                  ),
                ),
                SizedBox(
