...
import 'package:stagenew/toxicite/cutanee/ongles/q2.dart';
...
class OngleQ1 extends StatefulWidget {
  const OngleQ1({Key? key}) : super(key: key);

  @override
  State<OngleQ1> createState() => _OngleQ1();
}

class _OngleQ1 extends State<OngleQ1> {
  bool audio = false;
        ...
        child: SingleChildScrollView(
          child: SizedBox(
            ...
            child: Column(
              children: [
                Image.asset(
                  "lib/assets/ongles1.png",
                  height: size.height * 0.35,
                ),
                Text(
                  "واش الأظافر ديالك متقيحين؟  ",
                  style: GoogleFonts.lato(
                    textStyle: const TextStyle(
                      decoration: TextDecoration.none,
                      color: Colors.black,
                ...
                Footer(
                  ...
                  press: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => OngleQ2(rep1)));
                  },
                ),
              ],
            ),
