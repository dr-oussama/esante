...
class OngleQ6 extends StatefulWidget {
  String rep1 = '';
  String rep2 = '';
  String rep3 = '';
  String rep4 = '';
  String rep5 = '';
  OngleQ6(this.rep1, this.rep2, this.rep3, this.rep4, this.rep5, {Key? key})
      : super(key: key);

  @override
  State<OngleQ6> createState() => _OngleQ6();
}

class _OngleQ6 extends State<OngleQ6> {
  bool audio = false;
