...
import 'package:stagenew/toxicite/cutanee/ongles/q6.dart';

class OngleQ5 extends StatefulWidget {
  String rep1 = '';
  String rep2 = '';
  String rep3 = '';
  String rep4 = '';
  OngleQ5(this.rep1, this.rep2, this.rep3, this.rep4, {Key? key})
      : super(key: key);

  @override
  State<OngleQ5> createState() => _OngleQ5();
}

class _OngleQ5 extends State<OngleQ5> {
  bool audio = false;
                ...
                Footer(
                  ...
                  press: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => OngleQ6(widget.rep1,
                                widget.rep2, widget.rep3, widget.rep4, rep5)));
                  },
                ),
              ],
            ),
