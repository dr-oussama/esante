...
import 'package:stagenew/toxicite/cutanee/ongles/q4.dart';
...
class OngleQ3 extends StatefulWidget {
  String rep1 = '';
  String rep2 = '';
  OngleQ3(this.rep1, this.rep2, {Key? key}) : super(key: key);

  @override
  State<OngleQ3> createState() => _OngleQ3();
}

class _OngleQ3 extends State<OngleQ3> {
  bool audio = false;
                ...
                Footer(
                  ...
                  press: () {
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                OngleQ4(widget.rep1, widget.rep2, rep3)));
                  },
                ),
              ],
            ),
