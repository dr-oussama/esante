...
import 'package:stagenew/toxicite/cutanee/ongles/q3.dart';
...
class OngleQ2 extends StatefulWidget {
  String rep1 = '';
  OngleQ2(this.rep1, {Key? key}) : super(key: key);

  @override
  State<OngleQ2> createState() => _OngleQ2();
}

class _OngleQ2 extends State<OngleQ2> {
  bool audio = false;
                ...
                Footer(
                  ...
                  press: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => OngleQ3(widget.rep1, rep2)));
                  },
                ),
              ],
            ),
